...
class Empresa extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('Empresa Estetica Canina'),
      ), //findeappbar
      body: Center(
...
class Productos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('Productos Estetica Canina'),
      ), //findeappbar
      body: Center(
        child: Image.asset(
           "assets/lol.jpg",
...
class Contactos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('Contactos Estetica Canina'),
      ), //findeappbar
      body: Center(
         child: Image.asset(
           "assets/juarez.png",
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.black, image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/PedroPicasso3534/Imagenes/main/perrito.jpg"), alignment: Alignment.topCenter) //fin de decoration image
            ), //fin box decoration
